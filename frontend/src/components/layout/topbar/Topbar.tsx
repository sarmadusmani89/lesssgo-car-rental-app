...
export default function Topbar({ user, title, onMenuClick }: TopbarProps) {
    ...
    return (
        <header className="h-20 w-full sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200/50 flex items-center justify-between px-4 md:px-8 shadow-sm overflow-hidden">
            {/* Left */}
