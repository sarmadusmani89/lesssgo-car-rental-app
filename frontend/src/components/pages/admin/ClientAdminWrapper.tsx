...
import { LayoutDashboard, Car, Users, Calendar, Settings, LogOut, Mail } from 'lucide-react';
...
export default function ClientAdminWrapper({
  ...
  import { LayoutDashboard, Car, Users, Calendar, Settings, LogOut, Mail, Bell } from 'lucide-react';
