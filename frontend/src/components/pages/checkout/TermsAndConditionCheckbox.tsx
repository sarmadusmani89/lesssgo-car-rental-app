  ...
  return (
    <label className="flex items-center gap-4 cursor-pointer group p-2">
      <div className="relative">
        ...
        />
        <div className="w-6 h-6 border-2 border-gray-200 rounded-lg group-hover:border-accent peer-checked:bg-primary peer-checked:border-primary transition-all duration-300" />
