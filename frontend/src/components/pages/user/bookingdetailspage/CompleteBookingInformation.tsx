  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-50">
        <div>
          <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-0.5">Reference Data</label>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Booking Info</h2>
        </div>
        <div className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border ${getStatusStyle(booking.status)}`}>
          {booking.status}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
        <div className="space-y-4">
          ...
          <div>
            <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Schedule</label>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Pickup</label>
              <p className="text-xs font-semibold text-slate-600 uppercase">{booking.pickupLocation || 'Not specified'}</p>
            </div>
            <div>
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Return</label>
          ...
          <div className="pt-4 border-t border-slate-50 flex items-end justify-between">
            <div>
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-0.5">Total Amount</label>
              <p className="text-xl font-bold text-primary tracking-tight">K{booking.totalAmount}</p>
            </div>
            <div className="text-right">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block mb-0.5">Security Bond</label>
