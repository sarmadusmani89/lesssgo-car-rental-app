          ...
          <tr>
            <td style="padding: 40px 30px;">
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6; color: #333333;">
                Thank you for signing up with <strong>Car Rental</strong>! We're excited to have you on board.
              </p>
              ...
              <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #999999; border-top: 1px solid #e0e0e0; padding-top: 20px;">
                If you didn't create an account with Car Rental, you can safely ignore this email.
              </p>
            </td>
          </tr>
